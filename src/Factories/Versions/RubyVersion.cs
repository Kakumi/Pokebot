...
{
    public class RubyVersion : GameVersion
    {
        public override IActionRunner ActionRunner { get; }

        public RubyVersion(ApiContainer apiContainer, VersionInfo versionInfo, HashData hashData, GenerationInfo generationInfo)
